import {
  Badge, Box, Button, Image, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Text, useDisclosure,
...
export const ProductCard = ({ property }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    price_slab: property.price_slab,
    unitPrice: property.unitPrice,
    packedPrice: property.packedPrice,
    materialUsed: property.materialUsed,
    pack: [
      {
        quant: property.pack[0].quant,
        sizes: 0,
      },
    ],
    avgrating: 0,
